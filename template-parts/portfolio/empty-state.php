...
$fahar_empty_reset_url   = isset( $args['reset_url'] ) && is_string( $args['reset_url'] ) ? $args['reset_url'] : '';
?>
<div class="fahar-empty-state fahar-explore__empty">
	<div role="status">
	...
	<?php if ( $fahar_empty_reset_url && ( '' !== $fahar_empty_search_term || $fahar_empty_has_filters ) ) : ?>
		<a class="fahar-button fahar-button--secondary fahar-explore__empty-action" href="<?php echo esc_url( $fahar_empty_reset_url ); ?>"><?php esc_html_e( 'پاک‌کردن جستجو و فیلترها', 'fahar-theme-child' ); ?></a>
	<?php endif; ?>
</div>
<?php unset( $fahar_empty_search_term, $fahar_empty_has_filters, $fahar_empty_reset_url ); ?>
